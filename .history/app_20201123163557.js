...
function getdata(tm) {
  d3.json("Resources/basketball_table.json").then(function (nbaData) {
    ...
    console.log(salary1);
    colors = {"ATL" : "Red", "BRK": "Black", "BOS":"Green", "CHO":"purle", "CHI": "red", "CLE": "burgundy", "DAL": "blue", "DEN": "navy", "DET": "blue", "GWS": "Blue", "HOU": "red", "IND": "Blue", "LAC": "Red", "LAL": "Purple","MEM": "blue", "MIA": "maroon",
  "MIL": "gree", "MIN": "midnight blue", "NOP": "blue", "NYK": "orange", "OKC": "light blue", "ORL": "blue", "PHI": "blue", "PHX": "orange", "POR": "red", "SAC": "purple", "SAS": "gray", "TOR": "red", "UTA": "yellow", "WAS": "red"};
