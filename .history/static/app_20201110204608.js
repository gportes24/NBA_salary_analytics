...
function getdata(tm) {
  d3.json("Resources/basketball_table.json").then(function (nbaData) {
    ...
    var player_list = salary_test.map(data => data.Player===Player)[0];
...
var url = "http://127.0.0.1:5000/hoops.json";
console.log(url);
// d3.json("http://127.0.0.1:5000/hoops.json").then(function (nbaData){
//   console.log(nbaData);
// });
