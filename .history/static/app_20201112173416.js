...
function getdata(tm) {
  d3.json("Resources/basketball_table.json").then(function (nbaData) {
    ...
    var filtered = teamStats.filter(a => a.tm == tm);
    console.log(filtered);
    ...
    var salary1 = teamStats.map(data=> data.yr2019_20);
    console.log(salary1);

    // var salary1 = filtered.map(function(filtered){
    //   console.log(filtered.yr2019_20);
    // })

    // function markerSize(per){
    //   return per*1000000;
    // }
