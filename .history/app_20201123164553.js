...
function getdata(tm) {
  ...
  "MIL": "green", "MIN": "midnight blue", "NOP": "blue", "NYK": "orange", "OKC": "light blue", "ORL": "blue", "PHI": "blue", "PHX": "orange", "POR": "red", "SAC": "purple", "SAS": "gray", "TOR": "red", "UTA": "yellow", "WAS": "red"};
    console.log(colors);
    ...
    var trace = {
      ...
      text: player_list,
      orientation: "h",
      marker:dict(color=colors[teamnames])
    };
    var data = [trace];
