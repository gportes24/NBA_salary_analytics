...
function getdata(tm) {
  d3.json("Resources/basketball_table.json").then(function (nbaData) {
    ...
    console.log(salary1);
    var colors = {"ATL" : "Red", "BRK": "Black", "BOS":"Green", "CHO":"purple", "CHI": "red", "CLE": "burgundy", "DAL": "blue", "DEN": "navy", "DET": "blue", "GWS": "Blue", "HOU": "red", "IND": "Blue", "LAC": "Red", "LAL": "Purple","MEM": "blue", "MIA": "maroon",
    "MIL": "green", "MIN": "midnight blue", "NOP": "blue", "NYK": "FF7F03", "OKC": "light blue", "ORL": "blue", "PHI": "blue", "PHX": "FF7F0E", "POR": "red", "SAC": "purple", "SAS": "gray", "TOR": "red", "UTA": "yellow", "WAS": "red"};
    console.log(colors);
    var tmlist = salary_test.map(data=>data.tm);
    console.log(tmlist);
    testing2 = colors[tmlist];
