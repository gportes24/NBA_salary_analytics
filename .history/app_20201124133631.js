...
function getdata(tm) {
  d3.json("Resources/basketball_table.json").then(function (nbaData) {
    ...
    console.log(salary1);
    colors = {"ATL" : "Red", "BRK": "Black", "BOS":"Green", "CHO":"purple", "CHI": "red", "CLE": "burgundy", "DAL": "blue", "DEN": "navy", "DET": "blue", "GWS": "Blue", "HOU": "red", "IND": "Blue", "LAC": "Red", "LAL": "Purple","MEM": "blue", "MIA": "maroon",
